...
include::../architecture/decisions/ADR-001-mqtt-get-frequency.adoc[leveloffset=+3]
include::../architecture/decisions/ADR-002-mqtt-command-dispatcher.adoc[leveloffset=+3]
include::../architecture/decisions/ADR-003-cc1101-parameter-set-logic.adoc[leveloffset=+3]
include::../architecture/decisions/ADR-004-mqtt-response-parsing.adoc[leveloffset=+3]
include::../architecture/decisions/ADR-005-mqtt-cc1101-response-consistency.adoc[leveloffset=+3]
